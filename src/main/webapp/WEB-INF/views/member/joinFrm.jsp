...
<html lang="ko">
    ...
    <body class="d-flex flex-column h-100">
                    ...
                    <div class="rounded-3 py-5 px-4 px-md-5 mb-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-4">
                                <form action="/join.do" id="contactForm" name="form" method="post" autocomplete="off">
                                    <!-- Name input -->
                                    <h3 class="input-title">이름</h3>
                                    <div class="form-floating mb-4">
                                        <input class="form-control" id="memberName" name="memberName" type="text" placeholder="이름을 입력하세요" maxlength="10" />
                                        <label for="memberName">이름(실명)</label>
                                    ...
                                    <div class="form-floating mb-4">
                                        ...
                                        <label for="memberPw">영문, 숫자, 특수문자 조합 8~16자</label>
                                    ...
                                    <!-- Submit Button -->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg disabled" id="joinSubmit" type="submit">회원가입</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
	    ...
	    <!-- script -->
		<script type="text/javascript" src="/js/member/joinFrm.js"></script>
    </body>
</html>